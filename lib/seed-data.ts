...
export const SEED_ITEMS: Item[] = [
  ...
  { id: 'se-res-1', track: 'resource', sort_order: 1, title: 'A Philosophy of Software Design — Ousterhout', metadata: { type: 'book', author: 'John Ousterhout', url: 'https://www.amazon.com/Philosophy-Software-Design-John-Ousterhout/dp/1732902209' } },
  { id: 'se-res-2', track: 'resource', sort_order: 2, title: 'Clean Architecture — Robert C. Martin', metadata: { type: 'book', author: 'Robert C. Martin', url: 'https://www.amazon.com/Clean-Architecture-Craftsmans-Software-Structure/dp/0134494164' } },
  { id: 'se-res-3', track: 'resource', sort_order: 3, title: 'Designing Data-Intensive Applications — Kleppmann', metadata: { type: 'book', author: 'Martin Kleppmann', url: 'https://www.amazon.com/Designing-Data-Intensive-Applications-Reliable-Maintainable/dp/1449373321' } },
  { id: 'se-res-4', track: 'resource', sort_order: 4, title: 'Domain-Driven Design — Eric Evans', metadata: { type: 'book', author: 'Eric Evans', url: 'https://www.amazon.com/Domain-Driven-Design-Tackling-Complexity-Software/dp/0321125215' } },
  { id: 'se-res-5', track: 'resource', sort_order: 5, title: 'Release It! — Michael Nygard', metadata: { type: 'book', author: 'Michael Nygard', url: 'https://www.oreilly.com/library/view/release-it-2nd/9781680505264/' } },
  { id: 'se-res-6', track: 'resource', sort_order: 6, title: 'The Phoenix Project / The Unicorn Project — Gene Kim', metadata: { type: 'book', author: 'Gene Kim', url: 'https://www.amazon.com/Phoenix-Project-DevOps-Helping-Business/dp/1942788290' } },
  { id: 'se-res-7', track: 'resource', sort_order: 7, title: 'Building Microservices — Sam Newman', metadata: { type: 'book', author: 'Sam Newman', url: 'https://www.oreilly.com/library/view/building-microservices-2nd/9781492034025/' } },
  { id: 'se-res-8', track: 'resource', sort_order: 8, title: 'Software Architecture: The Hard Parts — Neal Ford et al.', metadata: { type: 'book', author: 'Neal Ford', url: 'https://www.oreilly.com/library/view/software-architecture/9781492085296/' } },
  { id: 'se-res-9', track: 'resource', sort_order: 9, title: 'Fundamentals of Software Architecture, 2nd Ed. — Richards & Ford', metadata: { type: 'book', author: 'Mark Richards & Neal Ford', url: 'https://www.oreilly.com/library/view/fundamentals-of-software/9781098114721/' } },
  { id: 'se-res-10', track: 'resource', sort_order: 10, title: 'Head First Design Patterns, 2nd Ed.', metadata: { type: 'book', url: 'https://www.amazon.com/Head-First-Design-Patterns-Brain-Friendly/dp/149207800X' } },
